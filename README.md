...
### 方式一: Deploy to Cloudflare Workers(生产部署)
...
```bash
# 克隆仓库
git clone https://github.com/Natdog-6ix9ine/nav.git
cd nav

# 安装依赖
npm install

# 启动本地开发服务器(完全本地,无需Cloudflare账号)
npm start

# 访问 http://localhost:8787 进行开发调试
```

开发完成后,提交代码并重新点击Deploy按钮部署即可。

详细开发指南请查看 [`DEV.md`](DEV.md:1)
